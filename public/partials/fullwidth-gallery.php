...
<div class="aigwl_fullwidth_gallery">
    <div class="aigwl_main">
        ...
        $fullwidth_gallery_image_alt = get_post_meta($attachment_id, '_wp_attachment_image_alt', TRUE);
        $fullwidth_gallery_image_title = get_the_title($attachment_id);
        ...
        <div class="aigwl_card">
            <div
                ...
                <a href="<?php echo esc_url(wp_get_attachment_url( $attachment_id ));?>" data-fancybox="aigwl_gallery">
                    <img class="fullwidth_gallery_img"
                        src="<?php echo esc_url(wp_get_attachment_url( $attachment_id ));?>"
                        alt="<?php echo esc_html($fullwidth_gallery_image_alt); ?>">
                    <?php if($aigwl_default_option['aigwl_image_hover_effect'] ==4){ ?>
                    <div class="aigwl_fullwidth_gallery_overlay">
                        <div class="aigwl_fullwidth_gallery_img_title">
                            <?php echo esc_html($fullwidth_gallery_image_title); ?></div>
                    </div>
                    <?php  } ?>
                </a>
            </div>
